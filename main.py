...
if __name__ == "__main__":
    ...
    GAME1_QUESTIONS = [
    {
        "text": "🎭 Кто главный в театре?",
        "options": ["Шамиль", "Ваниль", "Кенди Эпл", "Теневой Виноград"],
        "correct": "Шамиль"
    },
    {
        "text": "🧽 Что делает Ваниль?",
        "options": ["Моет полы", "Танцует", "Спит", "Играет на сцене"],
        "correct": "Моет полы"
    },
    {
        "text": "🍎 Какого цвета Кенди Эпл?",
        "options": ["Красное", "Зелёное", "Синее", "Фиолетовое"],
        "correct": "Красное"
    },
    {
        "text": "🍇 Кто украл корону?",
        "options": ["Теневой Виноград", "Ваниль", "Шамиль", "Кенди Эпл"],
        "correct": "Теневой Виноград"
    },
    {
        "text": "🎭 Что любит говорить Шамиль?",
        "options": ["ХА-ХА!", "Скучно", "Я устал", "Привет"],
        "correct": "ХА-ХА!"
    },
    {
        "text": "👑 Какая самая любимая фраза Шамиля про себя?",
        "options": ["Я гений", "Я король", "Я лох", "Я устал"],
        "correct": "Я король"
    },
    {
        "text": "🎪 Где происходит всё действие?",
        "options": ["В театре", "В школе", "В космосе", "В бассейне"],
        "correct": "В театре"
    },
    {
        "text": "🍪 Что Шамиль не любит?",
        "options": ["Печеньки", "Скуку", "Ваниля", "Корону"],
        "correct": "Скуку"
    },
    {
        "text": "🎭 Как зовут тряпку-помощника?",
        "options": ["Ваниль", "Кенди", "Тень", "Граф"],
        "correct": "Ваниль"
    },
    {
        "text": "🍇 Кто самый фиолетовый в театре?",
        "options": ["Теневой Виноград", "Шамиль", "Ваниль", "Кенди Эпл"],
        "correct": "Теневой Виноград"
    },
    {
        "text": "🎭 Что Шамиль носит на голове?",
        "options": ["Корону", "Шляпу", "Ведро", "Тряпку"],
        "correct": "Корону"
    },
    {
        "text": "🍎 Кто подруга Кенди Эпл?",
        "options": ["Вайт Лили", "Шамиль", "Теневой Виноград", "Ваниль"],
        "correct": "Вайт Лили"
    },
    {
        "text": "🎪 Кто создал Шамиля?",
        "options": ["Инна", "Ваниль", "Искусственный интеллект", "Случайность"],
        "correct": "Инна"
    },
    {
        "text": "🧹 Что Ваниль делает лучше всего?",
        "options": ["Моет полы", "Шутит", "Танцует", "Поёт"],
        "correct": "Моет полы"
    },
    {
        "text": "🎭 Какая любимая команда Шамиля?",
        "options": ["/spin", "/help", "/start", "/story"],
        "correct": "/spin"
    },
    {
        "text": "🍇 Что Теневой Виноград любит воровать?",
        "options": ["Корону", "Печеньки", "Тряпку", "Свет"],
        "correct": "Корону"
    },
    {
        "text": "🎭 Кто всегда смеётся последним?",
        "options": ["Шамиль", "Ваниль", "Кенди Эпл", "Зритель"],
        "correct": "Шамиль"
    },
    {
        "text": "🍎 Как зовут главную сладость театра?",
        "options": ["Кенди Эпл", "Шоко", "Карамель", "Мармелад"],
        "correct": "Кенди Эпл"
    },
    {
        "text": "🎪 Что случается, когда нажимаешь /spin?",
        "options": ["Колесо Фортуны", "Викторина", "История", "Шутка"],
        "correct": "Колесо Фортуны"
    },
    {
        "text": "👑 Кто написал этого бота?",
        "options": ["Инна (с помощью Дипсика)", "Шамиль", "Ваниль", "Искусственный интеллект"],
        "correct": "Инна (с помощью Дипсика)"
    }
    ]
